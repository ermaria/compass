          ...
          >
            ...
            <div>
              ...
              <Typography
                ...
                component="p"
                style={{ marginBottom: "5px", color: (isWideWindow || selectedTheme == 'dark') ? "#ffecac" : "#eda901" }}
              >
                PEARL HACKS
              </Typography>
              {!hasPearlHacksStarted() ?
                (<><Typography
                  variant="subtitle1"
                  component="div"
                  style={{
                ...
                (
                  <SecondaryButton href={"/live"} style={{ height: '100%' }}>
                    <AlarmIcon style={{ marginRight: "8px" }} />
                    HAPPENING NOW
                  </SecondaryButton>
                )
              }
